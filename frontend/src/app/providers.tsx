...
export const CONTRACT_IDS = {
  token: process.env.NEXT_PUBLIC_TOKEN_CONTRACT_ID || "CC3O6XWPJNRG7RWUKKBWAI3OMNTBWIPLEZ67UEXYIFHPIHCAPUZBOH5Y",
  oracle: process.env.NEXT_PUBLIC_ORACLE_CONTRACT_ID || "CDGQ2YMXWTDUK4WHNH7YU5BPLKMXAHS4LEDRWQAKZWAERR2NTHA66V4G",
  pool: process.env.NEXT_PUBLIC_POOL_CONTRACT_ID || "CAAFGCZY7DYO3IJMATZE6VC6BSACK2KFQOSOA4WPO7IXPYFCLHJTEQNN",
  governance: process.env.NEXT_PUBLIC_GOVERNANCE_CONTRACT_ID || "CDNBA52BE2D7BFUBOVFESFAUH62WGIJQUQFGAPSG7OI7SYNR5DWHSXJX",
};
